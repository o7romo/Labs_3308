...
*/
	...
	function switchPlayers(playerNum)
	{
		...
		document.getElementById('p_year').innerHTML = players[playerNum].year;
			...
			var passYards = players[playerNum].pass_yards;
			var rushYards = players[playerNum].rushing_yards;
			var recieveYards = players[playerNum].receiving_yards;
			var games = players[playerNum].games_played;

			var avgPassYards = Math.round(passYards/games);
			var avgRushYards = Math.round(rushYards/games);
			var avgRecYards = Math.round(recieveYards/games);
	...
	function loadPlayersPage()
	{
		...
		for(var i = 0; i < players.length; i++)
		{
			...
			menuAdd = menuAdd + "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + playerName +  "</a>";
		}
		document.getElementById("player_selector").innerHTML=menuAdd;
