...
app.get('/player_info', function(req, res) {
	var playerInfo = 'SELECT id, name FROM football_players;';

	res.render('pages/player_info',{
		text_variable:"player info",
		player: playerInfo
	});
});
...
app.get('/player_info', function(req, res) {
	var thePlayer = req.query.player_choice
	var playerId = 'SELECT id, name FROM football_players;';
	var playerInfo = 'SELECT * FROM football_players WHERE id = ' + thePlayer + '; ';
	var playerGames = 'SELECT COUNT(*) FROM football_games WHERE ' +thePlayer+' = player';
	db.task('get-everything', task => {
		return task.batch([
			task.any(playerId),
			task.any(playerInfo),
